...
#     ellipsoid_list = [root]
#     print(f"Initial ellipsoid count: 1")
...
#         print(f"Safe split iteration {split_iter}: {after} ellipsoids")
#         if after == before:
#             break
#     print(f"Ellipsoid count after safe splitting: {len(ellipsoid_list)}")
...
#     )
#     t1 = time.time()
#     print(f"Ellipsoid count after outlier refinement: {len(ellipsoid_list)}")
...
#     print(f"ARI: {ari:.4f}")
#     print("-" * 40)
#     print(f"Generation time: {t1 - t0:.6f}s")
#     print(f"Attribute time : {t2 - t1:.6f}s")
#     print(f"Cluster time   : {t3 - t2:.6f}s")
