...
def splits_ball(gb, splitting_method):
    ...
    if splitting_method == '2-means':
        ...
        label = k_means(X=gb, n_clusters=splits_k, n_init=1, random_state=8)[1]  # 返回标签,标签代表被划分到哪个新粒球中去
