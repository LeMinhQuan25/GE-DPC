...
# ============================================================
# Parameter Sensitivity Analysis for Iris
# ============================================================
...
def run_iris_parameter_sensitivity(
    base_dir: Path,
    repeats: int = 10,
    epsilon: float = 1e-6,
) -> List[Dict[str, object]]:
    """
    Runs parameter sensitivity analysis on Iris for the paper table.
    ...
    for parameter, value, kwargs in experiments:
        ...
        for _ in range(repeats):
            res = run_named_dataset(
                ...
                scaler_mode="none",
                k_candidates=[3],
                allow_graph=kwargs.get("allow_graph", False),
                show_chart=False,
    ...
    print("\n" + "=" * 90)
    print("PARAMETER SENSITIVITY ANALYSIS ON IRIS")
    print("=" * 90)
...
if __name__ == "__main__":
    ...
    # =========================
    # Run sensitivity analysis on Iris for paper table
    # =========================
    run_iris_parameter_sensitivity(
        base_dir=BASE_DIR,
        repeats=10,
        epsilon=epsilon,
    )
