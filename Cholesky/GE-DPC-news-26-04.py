...
def get_adaptive_dataset_config(dataset_name: str) -> Dict[str, object]:
    ...
    "segment_3":   {"scaler": "none", "k_candidates": [3], "allow_graph": True},
    "landsat_2":   {"scaler": "none", "k_candidates": [2], "allow_graph": True},
    "msplice_2":   {"scaler": "none", "k_candidates": [2, 3, 4], "allow_graph": True},
...
def run_ge_dpc_adaptive_quality(
    ...
    # 5) Evaluate by labels only after clustering is done
